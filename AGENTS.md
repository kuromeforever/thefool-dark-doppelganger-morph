...
- 目标为 Forge `47.4.12`、Dark Doppelganger `9.8.2-1.20.1`、AOM `0.3.0` 本轮 NativeSession API、BetterMorph 编译版本 `0.0.64`、运行范围 `[0.0.54,)`、Iron `3.15.6`、GeckoLib `4.8.4`、Travel `6.3.0-1.20.1`。依赖范围以元数据为准。
